...
pub fn main() !void {
    ...
    while (codepointIter.nextCodepoint()) |codepoint| {
        ...
        const graphemeExtend = script.generalCategory == GeneralCategory.Enclosing_Mark || GeneralCategory.Nonspacing_Mark; // + Other_Grapheme_Extend ??
        const extend = graphemeExtend || script.generalCategory == GeneralCategory.Spacing_Mark;
    }
}
