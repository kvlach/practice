...
impl Vector {
    ...
    fn write(self, mut f: &File) {
        ...
        let ln = format!("{} {} {}\n", r, g, b);
        f.write_all(ln.as_bytes()).expect("write failed");
    }
...
impl Ray {
    ...
    fn color(self) -> Color {
        ...
        let unit_direcetion = self.direction.unit();
        let a = 0.5 * (unit_direcetion.y + 1.0);
...
fn main() {
    ...
    let viewport_upper_left =
        camera_center - Vector::new(0.0, 0.0, focal_length) - viewport_u / 2 - viewport_v / 2;
